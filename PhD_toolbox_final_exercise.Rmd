...
HOME = "/media/stefania/DATA/sync/files_analisi_genomi/"

##List of cov scaffold 35 files
cov_sc35 = glob.glob(os.path.join(HOME, "*.coverage.bp.sc35.txt"))
#print cov_sc35
print "Source of data:", len(cov_sc35), "files called 'isolate_id'.coverage.bp.sc35.txt"
outfile = os.path.join(HOME, "all.cov.bp.sc35.txt")
